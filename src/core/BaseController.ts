 ...
 */
 ...
 export class BaseController<C extends BaseConfig, S extends BaseState> {
   ...
   private internalListeners: Listener<Partial<S>>[] = [];
    ...
    */
   notify(state: Partial<S>, resetting = false) {
     if (this.disabled) {
       return;
     }
    ...
    */
   subscribe(listener: Listener<Partial<S>>) {
